<template>
    <!-- <aside v-if="!visible" class="bg-green-400 shadow-sm shadow-black">
    ...
    <div class="hamburger-menu">
        <Button class="sticky h-10 " icon="pi pi-bars" @click="visible = true" />
    </div>
    <div class="card flex justify-content-center">
        <Sidebar v-model:visible="visible" style="width:18%;">
            <template #header>
                <div class="flex align-items-center gap-2 ml-5 ">
                    <img class="w-12 h-15 mx-auto shadow bg-white rounded-lg" src="/storage/images/logo.png" alt="" width="384" height="512">
                    <span class="font-bold">Lewis Hamilton</span>
                </div>
            </template>
            <div class="flex items-start justify-start border-b mt-2 border-top-3 border-none surface-border">
                <ul class="flex flex-col py-1 space-y-2">
                    <li class="px-5">
